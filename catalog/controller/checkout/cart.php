	...
	public function index() {
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			foreach ($products as $product) {
                ...
                elseif ($product_total>($this->config->get('user_verify_maxcount'))&&($this->config->get('user_verify_status'))) {
                    $data['error_warning'] = $this->language->get('error_user_validation');
            ...
            $data['user_validation'] = $this->load->controller('checkout/user_validation');
